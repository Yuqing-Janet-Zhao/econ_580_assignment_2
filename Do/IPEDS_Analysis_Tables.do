...
clear
global PATH "/Users/zhaosmac/Desktop/rf"

cd "/Users/zhaosmac/Desktop/rf/Data"
...
log using "/Users/zhaosmac/Desktop/rf/Output/table_1.txt", replace text
...
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_2", replace tex dec(3)  keep(semester2) 
*Column 2
areg costs                    semester2         i.year c.year#i.unitid       , absorb(unitid)  cluster(unitid) 
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_2", append tex dec(3)  keep(semester2) 
*Column 3
...
log using "/Users/zhaosmac/Desktop/rf/Output/table_2_means.txt", replace text
...
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a", replace tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, No)
*Column 2
areg gradrate4yr  block1 block2  $timevar i.year      [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, No)
*Column 3
areg gradrate4yr  block1 block2     i.year c.year#i.unitid  [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 4
areg gradrate4yr  block1 block2     i.year c.year#i.unitid $timevar   [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 5
...
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b", replace tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, No)
*Column 2
areg gradrate6yr  block1 block2  $timevar i.year      [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, No)
*Column 3
areg gradrate6yr  block1 block2     i.year c.year#i.unitid  [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 4
areg gradrate6yr  block1 block2     i.year c.year#i.unitid $timevar   [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 5
...
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a_appa2", replace tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 2
areg womengradrate4yr  block1 block2 $timevar   i.year c.year#i.unitid     , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3a_appa2", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 3
...
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b_appa2", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 2
areg womengradrate6yr  block1 block2 $timevar   i.year c.year#i.unitid     , cluster(unitid) abs(unitid)
outreg2 using "/Users/zhaosmac/Desktop/rf/Output/table_3b_appa2", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 3
